...
class CameraController:
    def __init__(self, src=0, model_path='resources/weights/yolov8n.pt'):
        self.src = src
    ...
    def start(self):
        ...
        self.process_thread = ProcessThread(self.capture_queue, self.process_queue, self.model_path)
        self.stream_thread = StreamThread(self.process_queue)
